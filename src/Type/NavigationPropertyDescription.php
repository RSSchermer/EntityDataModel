 ...
 */
class NavigationPropertyDescription extends AbstractResourcePropertyDescription
{
    ...
    public function setPartner(NavigationPropertyDescription $partner)
    {
        ...
        $partnerStructuredType = $partner->getStructuredType()->getOrThrow(new RuntimeException(
