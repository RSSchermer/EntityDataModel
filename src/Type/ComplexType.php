 ...
 */
class ComplexType extends AbstractStructuredType
{
    /**
     * @var MapInterface
     */
     ...
     *                                                                        type maps to.
     * @param AbstractStructuralPropertyDescription[] $structuralPropertyDescriptions Descriptions for each of the properties.
     *
     ...
     *
     * @param AbstractStructuralPropertyDescription $propertyDescription The property description to
     *                                                           be added to the complex type.
     *
     * @throws InvalidArgumentException Thrown if the complex type already has a property with
     *                                  the same name.
     */
    public function addStructuralPropertyDescription(AbstractStructuralPropertyDescription $propertyDescription)
    {
