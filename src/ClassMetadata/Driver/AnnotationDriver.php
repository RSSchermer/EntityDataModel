...
namespace RSSchermer\EntityModel\ClassMetadata\Driver;
...
use RSSchermer\EntityModel\ClassMetadata\Annotations as EDM;
...
class AnnotationDriver implements DriverInterface
{
    ...
    public function loadMetadataForClass(\ReflectionClass $class)
    {
        ...
        if ($typeAnnotation = $this->readClassAnnotation($class, 'EntityType')) {
            ...
            // base types in a schema and inherit properties that way.
    ...
    {
        $annotationClass = 'RSSchermer\EntityModel\ClassMetadata\Annotations\\' . $annotationName;
